...
set source4=%~dp0\pl.zip.bzprj\baseROM\system\
set destination4=%~dp0\miui.zip.bzprj\baseROM\system\
echo -------------------------------------------------------------------------------
...
rmdir /s /q "%~dp0\miui.zip.bzprj\appDecompiled\system__app\BugReport.apk\" 
rmdir /s /q "%~dp0\miui.zip.bzprj\appDecompiled\system__app\PaymentService.apk\" 
rmdir /s /q "%~dp0\miui.zip.bzprj\appDecompiled\system__app\Mipay.apk\" 
rmdir /s /q "%~dp0\miui.zip.bzprj\appDecompiled\system__app\VoiceAssist.apk\" 
rmdir /s /q "%~dp0\miui.zip.bzprj\appDecompiled\system__app\Stk.apk\" 
...
del /s /q "%~dp0\miui.zip.bzprj\baseROM\system\app\BugReport.apk"
del /s /q "%~dp0\miui.zip.bzprj\baseROM\system\app\PaymentService.apk"
del /s /q "%~dp0\miui.zip.bzprj\baseROM\system\app\Mipay.apk"
del /s /q "%~dp0\miui.zip.bzprj\baseROM\system\app\Stk.apk"
...
XCOPY "%system_app_pl%\DeskClock.apk\res\values-pl-xhdpi\*" "%system_app%\DeskClock.apk\res\values-pl-xhdpi" /s /i /y /q  
XCOPY "%system_app_pl%\DeskClock.apk\res\values-pl-xxhdpi\*" "%system_app%\DeskClock.apk\res\values-pl-xxhdpi" /s /i /y /q  
...
XCOPY "%system_app_pl%\miuisystem.apk\res\values-pl-rPL\*" "%system_app%\miui.apk\res\values-pl-rPL" /s /i /y /q  
...
XCOPY "%system_app_pl%\Updater.apk\res\values-pl-xxhdpi\*" "%system_app%\Updater.apk\res\values-pl-xxhdpi" /s /i /y /q  
...
XCOPY "%system_priv-app_pl%\InCallUI.apk\res\values-pl\*" "%system_app%\InCallUI.apk\res\values-pl" /s /i /y /q   
...
XCOPY "%source4%\media\theme\*" "%destination4%\media\theme" /s /i /y /q  
XCOPY "%source4%\media\bootanimation.zip" "%destination4%\media\bootanimation.zip*" /s /i /y /q  
echo -------------------------------------------------------------------------------
